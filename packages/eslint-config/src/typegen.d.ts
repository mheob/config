...
export type ConfigNames =
	| 'mheob/gitignore'
	| 'mheob/ignores'
	| 'mheob/javascript/rules'
	| 'mheob/eslint-comments/rules'
	| 'mheob/imports/rules'
	| 'mheob/command/rules'
	| 'mheob/perfectionist/setup'
	| 'mheob/perfectionist/rules'
	| 'mheob/astro/setup'
	| 'mheob/astro/rules'
	| 'mheob/jsdoc/rules'
	| 'mheob/jsonc/setup'
	| 'mheob/jsonc/rules'
	| 'mheob/sort/package-json'
	| 'mheob/sort/tsconfig-json'
	| 'mheob/jsx/setup'
	| 'mheob/nextjs/setup'
	| 'mheob/nextjs/rules'
	| 'mheob/node/rules'
	| 'mheob/react/setup'
	| 'mheob/react/rules'
	| 'mheob/react/typescript'
	| 'mheob/react/type-aware-rules'
	| 'mheob/regexp/rules'
	| 'mheob/stylistic/setup'
	| 'mheob/stylistic/rules'
	| 'mheob/svelte/setup'
	| 'mheob/svelte/rules'
	| 'mheob/test/setup'
	| 'mheob/test/rules'
	| 'mheob/toml/setup'
	| 'mheob/toml/rules'
	| 'mheob/typescript/setup'
	| 'mheob/typescript/type-aware-parser'
	| 'mheob/typescript/parser'
	| 'mheob/typescript/rules'
	| 'mheob/typescript/rules-type-aware'
	| 'mheob/unicorn/rules'
	| 'mheob/unicorn/rules/react'
	| 'mheob/vue/setup'
	| 'mheob/vue/rules'
	| 'mheob/yaml/setup'
	| 'mheob/yaml/rules'
	| 'mheob/sort/pnpm-workspace'
	| 'mheob/markdown/setup'
	| 'mheob/markdown/processor'
	| 'mheob/markdown/parser'
	| 'mheob/markdown/disables'
	| 'mheob/prettier/setup'
	| 'mheob/prettier/rules'
	| 'mheob/disables/bin'
	| 'mheob/disables/cli'
	| 'mheob/disables/cjs'
	| 'mheob/disables/config-files'
	| 'mheob/disables/conflicts'
	| 'mheob/disables/dts'
	| 'mheob/disables/jsx'
	| 'mheob/disables/scripts'
	| 'mheob/disables/test';
