...
export type ConfigNames = 'mheob/astro/setup' | 'mheob/astro/rules' | 'mheob/eslint-comments/rules' | 'mheob/imports/rules' | 'mheob/javascript/rules' | 'mheob/jsdoc/rules' | 'mheob/jsonc/setup' | 'mheob/jsonc/rules' | 'mheob/markdown/setup' | 'mheob/markdown/processor' | 'mheob/markdown/parser' | 'mheob/markdown/disables' | 'mheob/nextjs/setup' | 'mheob/nextjs/rules' | 'mheob/node/rules' | 'mheob/perfectionist/setup' | 'mheob/perfectionist/rules' | 'mheob/prettier/setup' | 'mheob/prettier/rules' | 'mheob/react/setup' | 'mheob/react/rules' | 'mheob/regexp/rules' | 'mheob/sort/package-json' | 'mheob/svelte/setup' | 'mheob/svelte/rules' | 'mheob/test/setup' | 'mheob/test/rules' | 'mheob/toml/setup' | 'mheob/toml/rules' | 'mheob/typescript/setup' | 'mheob/typescript/parser' | 'mheob/typescript/rules' | 'mheob/unicorn/rules' | 'mheob/unicorn/rules/markdown' | 'mheob/unicorn/rules/react' | 'mheob/vue/setup' | 'mheob/vue/rules' | 'mheob/yaml/setup' | 'mheob/yaml/rules'
